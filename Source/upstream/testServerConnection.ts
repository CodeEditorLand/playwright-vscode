...
import type {
	TestServerInterface,
	TestServerInterfaceEvents,
} from "./testServerInterface";
	...
	implements TestServerInterface, TestServerInterfaceEvents
{
	...
	async initialize(
		params: Parameters<TestServerInterface["initialize"]>[0],
	): ReturnType<TestServerInterface["initialize"]> {
		await this._sendMessage("initialize", params);
	}

	async ping(
		params: Parameters<TestServerInterface["ping"]>[0],
	): ReturnType<TestServerInterface["ping"]> {
	...
	async watch(
		params: Parameters<TestServerInterface["watch"]>[0],
	): ReturnType<TestServerInterface["watch"]> {
	...
	async open(
		params: Parameters<TestServerInterface["open"]>[0],
	): ReturnType<TestServerInterface["open"]> {
	...
	async resizeTerminal(
		params: Parameters<TestServerInterface["resizeTerminal"]>[0],
	): ReturnType<TestServerInterface["resizeTerminal"]> {
	...
	async checkBrowsers(
		params: Parameters<TestServerInterface["checkBrowsers"]>[0],
	): ReturnType<TestServerInterface["checkBrowsers"]> {
		return await this._sendMessage("checkBrowsers", params);
	}

	async installBrowsers(
		params: Parameters<TestServerInterface["installBrowsers"]>[0],
	): ReturnType<TestServerInterface["installBrowsers"]> {
		await this._sendMessage("installBrowsers", params);
	}

	async runGlobalSetup(
		params: Parameters<TestServerInterface["runGlobalSetup"]>[0],
	): ReturnType<TestServerInterface["runGlobalSetup"]> {
		return await this._sendMessage("runGlobalSetup", params);
	}

	async runGlobalTeardown(
		params: Parameters<TestServerInterface["runGlobalTeardown"]>[0],
	): ReturnType<TestServerInterface["runGlobalTeardown"]> {
		return await this._sendMessage("runGlobalTeardown", params);
	}

	async startDevServer(
		params: Parameters<TestServerInterface["startDevServer"]>[0],
	): ReturnType<TestServerInterface["startDevServer"]> {
		return await this._sendMessage("startDevServer", params);
	}

	async stopDevServer(
		params: Parameters<TestServerInterface["stopDevServer"]>[0],
	): ReturnType<TestServerInterface["stopDevServer"]> {
		return await this._sendMessage("stopDevServer", params);
	}

	async clearCache(
		params: Parameters<TestServerInterface["clearCache"]>[0],
	): ReturnType<TestServerInterface["clearCache"]> {
		return await this._sendMessage("clearCache", params);
	}

	async listFiles(
		params: Parameters<TestServerInterface["listFiles"]>[0],
	): ReturnType<TestServerInterface["listFiles"]> {
		return await this._sendMessage("listFiles", params);
	}

	async listTests(
		params: Parameters<TestServerInterface["listTests"]>[0],
	): ReturnType<TestServerInterface["listTests"]> {
		return await this._sendMessage("listTests", params);
	}

	async runTests(
		params: Parameters<TestServerInterface["runTests"]>[0],
	): ReturnType<TestServerInterface["runTests"]> {
		return await this._sendMessage("runTests", params);
	}

	async findRelatedTestFiles(
		params: Parameters<TestServerInterface["findRelatedTestFiles"]>[0],
	): ReturnType<TestServerInterface["findRelatedTestFiles"]> {
		return await this._sendMessage("findRelatedTestFiles", params);
	}

	async stopTests(
		params: Parameters<TestServerInterface["stopTests"]>[0],
	): ReturnType<TestServerInterface["stopTests"]> {
	...
	async closeGracefully(
		params: Parameters<TestServerInterface["closeGracefully"]>[0],
	): ReturnType<TestServerInterface["closeGracefully"]> {
